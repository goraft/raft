...
- [Weed File System](https://weed-fs.googlecode.com) - A distributed key-to-file system based on Facebook Haystack paper, with O(1) disk access for each request. Using Raft for high available master nodes.
